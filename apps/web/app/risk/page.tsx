...
export default function RiskPage() { return <AuthenticatedTerminalPage activeRoute="risk" eyebrow="Risk engine · First-class safety" title="Risk management" description="Observe current PAPER or LIVE exposure, risk verdicts, broker-position audit state, and the real mode-aware kill-switch controls.">{(status, refresh) => <RiskPanel status={status} refresh={refresh} />}</AuthenticatedTerminalPage>; }
