...
function unavailableStatus(message:string):ControlStatus{return{controlPlane:{healthy:false,errors:{status:message}},worker:{online:false,stale:false,state:"offline",market_data_status:"unavailable"},paperEngine:{running:false,state:"unavailable",feed_connected:false},executionControl:null,latestCommand:null,credentials:{configured:false,updatedAt:null},latestSignal:null,recentSignals:[],levels:[],paperOrders:[],paperTrades:[],paperOutcomes:[]};}
