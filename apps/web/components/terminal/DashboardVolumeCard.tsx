...
export function DashboardVolumeCard(){
  ...
  return <section className="terminal-section card"><div className="section-heading compact"><div><p className="eyebrow">Whole NIFTY volume</p><h2>1-minute NIFTY-50 participation bars</h2></div><span>Latest uninterrupted engine run</span></div>{error&&<p className="availability-note">{error}</p>}<NiftyVolumeChart points={points}/></section>;
}
